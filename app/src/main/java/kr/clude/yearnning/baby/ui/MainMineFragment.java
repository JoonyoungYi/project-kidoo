 ...
 * Use the {@link kr.clude.yearnning.baby.ui.MainMineFragment#newInstance} factory method to
...
public class MainMineFragment extends Fragment {
     ...
     */
    public static MainMineFragment newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLvAdapter = new LvAdapter(getActivity(), R.layout.main_mine_fragment_lv, sitters);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.mCardBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    WriteActivity.startActivity(getActivity(), sitter.id);
                }
            });
